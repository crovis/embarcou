            ...
            <div class="container headline">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-1">
                                <form role="form" method="POST" action="nova_viacao" name="novaViacao">
                                    <div class="form-group">
                                        <label for="inputCnpj">CNPJ</label>
                                        <input type="text" class="form-control" name="cnpj_data" id="inputCnpj" placeholder="CNPJ da viação">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputNome">Nome da viação</label>
                                        <input type="text" class="form-control" name="nome" id="inputNome" placeholder="Nome da viação">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="site" id="inputSite" placeholder="www.site.com">
                                    </div>
                                    <div class="form-group">
